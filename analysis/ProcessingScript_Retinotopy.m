...
%% Subject-specific information: ALW
% subjDate = '\AW\AWOct27';
% 
...
%% Subject-specific information: JM
% subjDate = '\JM\JMNov30';
% 
...
%% Subject-specific information: JS (Joseph), BVIS_003
% subjDate = '\JS\JSFeb04';
% 
...
%% Subject-specific information: KB (Kadie), BVIS_006
...
%% Subject-specific information: DP (Dan), BVIS_007
...
% for i=1:numSets
%     processedFMRs{i} = fullfile(fmrFolders{i},sprintf('s%i_SCLAI_3DMCTS_LTR_THPGLMF2c.fmr',i));
% end
